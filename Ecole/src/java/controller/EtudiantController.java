    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("add")!=null){
         ...
         if(request.getParameter("delete")!=null){
             ...
             e.setId(id);
            try {
                e.delete((new Connexion()).connect());
            } catch (Exception ex) {
         ...
         if(request.getParameter("find")!=null){
            Etudiant e=new Etudiant();
            try {
                DBTable[] allEtudiants=e.find("select * from Etudiant");
                request.setAttribute("listeEtudiant",allEtudiants);
                
            } catch (Exception ex) {
                Logger.getLogger(EtudiantController.class.getName()).log(Level.SEVERE, null, ex);
            }
            RequestDispatcher dispat = request.getRequestDispatcher("vue/template.jsp?vue=listeEtudiant");
            dispat.forward(request,response); 
        }
    }
